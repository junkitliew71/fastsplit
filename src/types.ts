...
export type Receipt = Pick<Bill,'restaurant'|'items'|'serviceChargeCents'|'taxCents'|'discountCents'> & { scanWarning?: string; printedTotalCents?: number | null; receiptNeedsReview?: boolean };
