...
function inferredAnchors(layout: ReceiptLayout): Anchors {
  ...
  const base={...fromHeader,lineTotal:fromHeader.lineTotal??clusteredAnchor(moneyX,tolerance,true),quantity:fromHeader.quantity??clusteredAnchor(quantityX,tolerance)};
