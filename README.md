...
PWA support uses a manifest for Add to Home Screen. Receipt history needs a network connection; the site does not promise offline history. Test camera and native sharing on physical iPhone/Android devices before claiming full device certification.
